...
class SettingsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        dataRefreshRateSwitch.isOn = (appDelegate?.userDataController.userData.refreshDataLessFrequently == true)
        notifyOnceSwitch.isOn = (appDelegate?.userDataController.userData.onlyNotifyOnce == true)
    }
